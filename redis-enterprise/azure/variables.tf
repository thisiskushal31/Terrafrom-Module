...
variable "cloud_account_id" {
  type        = number
  default     = null
  description = "Redis Cloud account ID. Default = 1 (Redis Labs internal account)"
}
...
variable "preferred_availability_zones" {
  type        = list(string)
  default     = []
  description = "Preferred availability zones for the region (check Redis Cloud docs for Azure zone IDs)"
}
